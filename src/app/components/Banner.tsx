...
export default function Banner() {
  ...
  return (
    <div className="bg-gradient-to-r from-purple-200 to-pink-200 dark:from-purple-800 dark:to-pink-800 text-slate-800 dark:text-white p-6 rounded-2xl shadow-lg mx-auto transition-all duration-300  w-full">
